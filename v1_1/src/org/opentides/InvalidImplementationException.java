...
public class InvalidImplementationException extends RuntimeException {
     ...
     */
    public InvalidImplementationException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param message - error message
     */
    public InvalidImplementationException(final String message) {
        super(message);
    }
     ...
     * @param cause - root cause
     */
    public InvalidImplementationException(final Throwable cause) {
        super(cause);
    }
