...
/**
 * This is the controller class for UserDefinedField.
 * Auto generated by high tides.
 * @author hightides
 */
 
public class UserDefinedFieldController extends BaseCrudController<UserDefinedField> {
	...
	/**
	 * This method initialize the userFields  by listing all available fields
	 * in UserDefinedRecord.
	 */
	@SuppressWarnings("rawtypes")
	private static void initializeUserFields() {
		...
		for (Method method:methods) {
			...
			if (name.startsWith("get") &&
				!name.startsWith("getEntity")) {
				userFields.add(name.substring(3,4).toLowerCase() +
						name.substring(4));
			}
		}
	}
	...
	/**
	 * This method initialize the udfClasses by checking all classes
	 * that implements UserDefinedRecord.
	 */
	@SuppressWarnings("rawtypes")
