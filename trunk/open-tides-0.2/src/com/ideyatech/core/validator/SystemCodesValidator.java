...
public class SystemCodesValidator implements Validator {
	...
	public void validate(Object clazz, Errors e) {
		ValidationUtils.rejectIfEmpty(e, "category", "error.required", new Object[]{"Category"});
		ValidationUtils.rejectIfEmptyOrWhitespace(e, "key", "error.required", new Object[]{"Key"});
		ValidationUtils.rejectIfEmptyOrWhitespace(e, "value", "error.required", new Object[]{"Value"});
	}
}
