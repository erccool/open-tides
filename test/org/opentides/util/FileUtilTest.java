...
public class FileUtilTest {
	...
	/**
	 * Test method for {@link org.opentides.util.FileUtil#getMD5sum(java.io.File)}.
	 */
	@Test
	public void testGetMD5sum() {
		File file = new File("test/resources/testing.txt");
		String content = FileUtil.getMD5sum(file);
		Assert.assertEquals("3c9594da488768779f8abbdcbe3431e3", content);
	}
