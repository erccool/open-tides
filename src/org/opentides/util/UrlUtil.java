...
public class UrlUtil {
	...
	/**
	 * Checks if the given url starts with protocol (e.g. "http://www.ideyatech.com")
	 * @param url
	 * @return
	 */
	 ...
	 * If none, the protocol is prepended on the url and returned as String.
	 * @param url
	 * @param protocol
	 * @return
	 */
	 ...
	 * If none, http:// is prepended on the url and returned as String.
	 * @param url
	 * @return
	 */
	...
	/**
	 * Returns the correct absolute path of the given src
	 * relative to the url. For example:
	 * url=http://hostname/sample.html, src=/test.gif -> http://hostname/test.gif
	 * src=http://hostname/folder/sample.html, src=test.gif -> http://hostname/folder/test.gif
	 * 
	 * @param url - url location where src is specified
	...
	public static String getAbsoluteUrl(String url, String src) {
		...
		return protocol + "://" + url.substring(startIndex, endIndex) + "/" + src;
	}
